            ...
            Function()
                Using service As ChromeDriverService = Nothing,
                    ...
                    Try
                        ...
                        LogMessage(Me, "StatusMsg_LoginPageLoaded")

                        LogMessage(Me, "StatusMsg_AnalyzingPageContent")
                        Dim firstNewsText As String =
                            CStr(driver.ExecuteScript("return document.querySelector('div.site-news-inner li.news-item:first-child')?.textContent;"))
